...
public class RoomForm extends JFrame {
    ...
    public RoomForm() {
        ...
        buttonPanel.add(btnSave); buttonPanel.add(btnShowAvailable);
    ...
    private void showAvailableRooms() {
        ...
        while(iterator.hasNext()) {
            ...
            model.addRow(new Object[]{ r.getRoomId(), r.getType(), r.getPrice(), r.isAvailable() });
        }
    }
    ...
    private void clearFields() {
        txtId.setText(""); txtPrice.setText(""); chkAvailable.setSelected(false);
    }
